...
const Stories: NextPage = () => {
  ...
  const allStories = [
    <div key="1" className={styles.storyCard}>
      ...
      Двоє дітей, чоловік на фронті. Я трималась як могла, але ввечері зривалась на дітей через будь-яку дрібницю. А потім лежала і плакала від сорому. Щовечора одне й те саме. <br /><br />Побачила рекламу, пройшла тест. Думала — ну 149 грн,що я втрачу? Гірше вже не буде. <br /><br />На 2-й день зробила вечірню практику перед тим,як забирати дітей з садочка. Вперше за місяціне підвищила голос увесь вечір. <br /><br />На 3-й день донька сказала: «Мамо, ти стала добріша». <br /><br />Це було найкраще, що я чула за рік.
      </p>
    </div>,
