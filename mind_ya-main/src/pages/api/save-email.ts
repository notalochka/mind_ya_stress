...
export default async function handler(
  ...
  try {
    ...
    const scriptUrl = process.env.GOOGLE_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbxM_sSAxuPtwIwK-YOYp5tDEj966ngb8UzR2w8RU7ymtdPnM9O5_-mXThXjuPZLYmIefw/exec';
